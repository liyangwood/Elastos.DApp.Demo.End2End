...
class Util {
  ...
  public static function isSameDomain($url1, $url2) {
		...
		// Jacky change here
		// The reason is when open web client with file protocol, like open html in directly or in cordova env. that will stop the process and return http status 500.

    return false;
		// return self::getFullDomain($url1) === self::getFullDomain($url1);
	}
